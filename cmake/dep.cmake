...
if (GLPK_FOUND)
    set(GLPK_DEFINITION "-DWITH_GLPK")
    message (STATUS "Found GLPK:")
    message (STATUS "  (Headers)       ${GLPK_INCLUDE_DIR}")
    message (STATUS "  (Library)       ${GLPK_LIBRARY}")
    message (STATUS "  (Definition)    ${GLPK_DEFINITION}")
else()
    message (STATUS "Could NOT find GLPK")
endif()
